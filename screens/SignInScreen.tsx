...
// Assuming `promptAsync` returns a promise that resolves to a string
export default function SignInScreen({ promptAsync }: { promptAsync: () => Promise<AuthSessionResult> }) {
  return (
    <SafeAreaView
